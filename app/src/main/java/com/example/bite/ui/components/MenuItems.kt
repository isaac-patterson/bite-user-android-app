...
import com.example.bite.model.CollectionType
import com.example.bite.model.MenuItem
import com.example.bite.model.SnackCollection
import com.example.bite.model.snacks
import com.example.bite.ui.theme.BiteTheme
import com.example.bite.ui.utils.mirroringIcon
...
private fun HighlightedSnacks(
    ...
    val gradient = when ((index / 2) % 2) {
        0 -> BiteTheme.colors.gradient6_1
        else -> BiteTheme.colors.gradient6_2
    }
    // The Cards show a gradient which spans 3 cards and scrolls with parallax.
...
@Composable
private fun MenuItemsComponent(
...
//            modifier = Modifier
//                .clickable(onClick = { onSnackClick(menuItem.id) })
//                .padding(8.dp)
//        ) {
//            MenuItemImage(
...
fun MenuItemCardPreview() {
    BiteTheme {
        ...
        HighlightSnackItem(
            ...
            onSnackClick = { },
            index = 0,
            gradient = BiteTheme.colors.gradient6_1,
